...
local themes = {
    Default = {
        ["Accent"] = Color3.fromRGB(90, 136, 173),
...
local themeobjects = {}
          ...
          local library = utility.table({theme = table.clone(themes.Default), folder = "AZRF", extension = "AZR", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
